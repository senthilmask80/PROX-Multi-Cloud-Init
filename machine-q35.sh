...
function create_template() {
    ...
    qm create $1 --name $2 --machine q35 
    ...
    qm set $1 --bios ovmf --efidisk0 ${storage}:1,efitype=4m,pre-enrolled-keys=1
	...
	pvesm set local --content backup,iso,snippets
    #qm set $1 --cicustom "users=local:snippets/debian-12.yaml"
    #Make it a template
    qm template $1
